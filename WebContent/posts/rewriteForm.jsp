...
<option value="" disabled>게시판 선택</option>
			...
			<div class="subject">
			<label>제목:</label>
			<input type="text" name="subject"  value="[답글]" autocomplete="off">
			</div>
	<textarea name="content" id="ir1" rows="10" cols="100" style="width:762px; height:412px; display:none;"></textarea>
	<!--textarea name="ir1" id="ir1" rows="10" cols="100" style="width:100%; height:412px; min-width:610px; display:none;"></textarea-->
	
		<div class="btn_group">
		<input class="reset_btn" type="button" onclick="history.back();" value="뒤로가기">
		<input class="submit_btn" type="button" onclick="submitContents(this);" value="작성완료" />
		</div>
