...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    -->
    <link rel="stylesheet" href="/LOLSearch/daumeditor/css/editor.css" type="text/css" charset="utf-8"/>
    <script src="/LOLSearch/daumeditor/js/editor_loader.js" type="text/javascript" charset="utf-8"></script>
...
<div class="body">
	...
	-->
	<form name="tx_editor_form" id="tx_editor_form" action="./rewriteAction.net" method="post" accept-charset="utf-8" style="width:700px">
		<!-- 에디터 컨테이너 시작 -->
		...
		<div id="tx_trex_container" class="tx-editor-container">
			<div class="tx-sidebar center">
			<div class="margin">
			<select name="boardType" id="boardType" readonly 
        style="background-color:#ababab" 
        onFocus="this.initialSelect = this.selectedIndex;" 
        onChange="this.selectedIndex = this.initialSelect;">
			<option value="" disabled>게시판 선택</option>
			<option value="자유" <%if(type.equals("자유")){%>selected<%} %>>자유</option>
			<option value="유머" <%if(type.equals("유머")){%>selected<%} %>>유머</option>
			<option value="영상" <%if(type.equals("영상")){%>selected<%} %>>영상</option>
			</select>
			제목:<input type="text" name="subject" style="width:500px;" value="[답글]">
			</div><!-- 상하여백 -->
			</div><!-- tx-sidebar -->
			<!-- 사이드바 -->
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="/LOLSearch/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="/LOLSearch/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="/LOLSearch/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_resizer" class="tx-resize-bar">
		...
		<img id="tx_resize_holder" src="/LOLSearch/daumeditor/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" />
	</div>
					<div class="tx-side-bi" id="tx_side_bi">
		<div style="text-align: right;">
			<img hspace="4" height="14" width="78" align="absmiddle" src="/LOLSearch/daumeditor/images/icon/editor/editor_bi.png" />
		</div>
	</div>
				<!-- 편집영역 끝 -->
			<!-- 첨부박스 시작 -->
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="/LOLSearch/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
	...
	<div><button onclick='saveContent()'>글작성하기</button></div>
<!-- End: Saving Contents -->
...
<script type="text/javascript">
	...
	form.createf
	 ...
	 $(document).ready(function(){
		$("iframe").contents().find(".tx-content-container>p").focus();
	 });
